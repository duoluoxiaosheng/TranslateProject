...
尽管让事情变得简单和方便时好事，但还是用几个理由说明我们不应该害怕尝试 Linux 终端。

在这里，我将重点介绍其中的一些，以鼓励你在终端中尝试一些最终会对您有所帮助的东西。

### 1. 快速熟悉命令

![quick info terminal][1]

有时，你需要使用某个命令在终端中执行一些操作。当然，你可以在不知道他到底做什么点情况下复制粘贴。

但是，如果你想知道这条指令更多的信息，该怎么办呢？
...
与使用图形界面访问远程服务器相比，使用 Linux 终端可以让你用最小的带宽迅速的执行任何你想要的操作。
...
就我个人来说，当我刚开始解除 Linux 时，我也对终端心存畏惧。但是当我可以熟练的使用它处理一些简单任务的时候，我才开始意识到上面所说的终端的优点。
